...
if (isset($_POST['submit'])) {
    ...
    $isGLAA = ($_POST['optionsRadiosInline'] == 'yes') ? 1 : 0;

    if (!$_POST['institutionName'])
        $errName = 'Please enter an institution name';
    ...
    if (!$errName) 
    {
        ...
        else
        {
            ...
            $alertType = 'alert-success';
            $alertBold = 'Success!';
            $alertInfo = 'The institution has been added.';
        }
    }
    $conn->close();
}
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <!-- Alert Info -->
                <div class="alert <? echo $alertType; ?> alert-dismissible <? echo $alertHidden; ?>" id="resultAlert" role="alert">
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <strong><? echo $alertBold; ?></strong> <? echo $alertInfo; ?>
                </div>
                <!-- ./alert -->

                <!-- form -->
                <form role="form" action="add_institution.php" method="post">
                    <div class="form-group">
                        <label>Institution Name</label>
                        <input name="institutionName" type="text" maxlength="100" class="form-control" placeholder="Maximum length: 100 characters">
                        <? echo "<p class='text-danger'>$errName</p>"; ?>
                    </div>

                    <div class="form-group">
                        <label>Is GLAA Member?</label>
                        <br>
                        <label class="radio-inline">
                            <input type="radio" name="optionsRadiosInline" id="isGLAATrue" value="yes" checked>Yes
                        </label>
                        <label class="radio-inline">
